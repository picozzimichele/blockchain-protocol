...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = "Piero", amount = 1) #this specifies the reward to the miner, the sender is the node itself, receiver is the miner and amount is the reward
